...
class BaseNet(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(256, 200) # 200 could be changed to an arbitrary number 
...
class BaseNetAux(nn.Module):
    def __init__(self):
        ...
        self.fc1_1 = nn.Linear(256, 200) # 200 could be changed to an arbitrary number
        self.fc1_2 = nn.Linear(256, 200) # 200 could be changed to an arbitrary number 
        ...
        self.fc3 = nn.Linear(20, 200) # 200 could be changed to an arbitrary number 
        self.fc4 = nn.Linear(200, 2)  # 200 could be changed to an arbitrary number 
